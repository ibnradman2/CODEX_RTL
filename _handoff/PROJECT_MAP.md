...
[ORPHANS & PENDING]
- التحقق البصري بعد فتح اختصار `Codex RTL` المحدث إلى النسخة المحمولة. عند الضغط عليه سيغلق نافذة Codex الحالية ثم يفتح النسخة المحلية المعدلة. يجب ألا يظهر أي تأثير بصري تجريبي، ويجب ألا تتداخل أيقونات أعلى اليمين، ويجب أن يظهر عنوان الدردشة RTL في مكانه.
