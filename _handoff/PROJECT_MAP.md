...
- نتيجة التنفيذ:
  ...
  - يتم إنشاء النسخة المحلية المعدلة داخل:
    `_codex_rtl_app\app`
  ...
  - اختصار سطح المكتب `Codex RTL.lnk` يستدعي `launch-codex-rtl-local.vbs` ثم `launch-codex-rtl-local.ps1` بمسارات نسبية من مكان المستودع.
